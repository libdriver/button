...
LibDriver BUTTON支持单按钮检测，可以以更高效的方法运行, 如果您需要多按键或者矩阵按键检测, 请参考[https://github.com/libdriver/multi_button](https://github.com/libdriver/multi_button)。
...
/src目录包含了LibDriver BUTTON的源文件。

/interface目录包含了LibDriver BUTTON与平台无关的GPIO总线模板。

/test目录包含了LibDriver BUTTON驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver BUTTON编程范例。

/doc目录包含了LibDriver BUTTON离线文档。

/datasheet目录包含了BUTTON数据手册。
...
在线文档: [https://www.libdriver.com/docs/button/index.html](https://www.libdriver.com/docs/button/index.html)。
